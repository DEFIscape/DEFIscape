...
<i>($1–2B frozen TVL estimate: DeFiLlama inactive protocols (~$2.1B in zero-activity TVL) + EigenPhi zombie liquidity ($1–2B in abandoned pools, 2024/2025). Sources: [DeFiLlama](https://defillama.com/protocols) + [EigenPhi Report](https://eigenphi.substack.com/p/mev-outlook-2023).)</i>
...
<p align="center">
  <a href="https://www.youtube.com/watch?v=PoYP-m6UISU" target="_blank">
    <img src="assets/video_defiscape.png" width="500" style="border-radius:12px; box-shadow: 0 4px 20px rgba(0,0,0,0.3);"/>
  </a>
</p>
